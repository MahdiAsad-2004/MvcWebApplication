    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { (byte)1, "Address", "Descriptions", "OrganicShop@gmail.com", null, "Tehran", null, null, "02134658899", null, null, "09121234455", null, null, "ShorDescriptions", new DateTime(2024, 4, 22, 22, 33, 35, 547, DateTimeKind.Local).AddTicks(3072), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 547, DateTimeKind.Local).AddTicks(3131) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { (byte)1, "Main Admin", null, "مدیر سایت", new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6208), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6263) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "mas1379as@gmail.com", "Mahdi Asadi", "123456", "09369753041", 2, new DateTime(2024, 4, 22, 22, 33, 35, 563, DateTimeKind.Local).AddTicks(3145), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 563, DateTimeKind.Local).AddTicks(3201) },
                    { 2L, "TestEmail@gmail.com", "AmirAli", "1234", "09331234566", 3, new DateTime(2024, 4, 22, 22, 33, 35, 563, DateTimeKind.Local).AddTicks(3390), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 563, DateTimeKind.Local).AddTicks(3398) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { (byte)2, "Users Admin", (byte)1, "مدیریت کاربران", new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6272), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6280) },
                    { (byte)3, "Products Admin", (byte)1, "مدیریت محصولات", new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6287), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6289) },
                    { (byte)4, "Permissions Admin", (byte)1, "مدیریت مجوز ها", new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6293), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6296) },
                    { (byte)5, "Comments Admin", (byte)1, "مدیریت نظرات", new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6309), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6311) },
                    { (byte)6, "Discounts Admin", (byte)1, "مدیریت تخفیف ها", new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6316), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6318) },
                    { (byte)7, "Categories Admin", (byte)1, "مدیریت دسته ها", new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6321), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6343) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, null, true, "jocker.png", null, 0.5f, 0, 1L, new DateTime(2024, 4, 22, 22, 33, 35, 558, DateTimeKind.Local).AddTicks(6815), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 558, DateTimeKind.Local).AddTicks(6862) });

            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "EnTitle", "ParentId", "Title", "BaseEntity_CreateDate", "BaseEntity_DeleteDate", "BaseEntity_IsActive", "BaseEntity_IsDelete", "BaseEntity_LastModified" },
                values: new object[] { (byte)8, "Giving Permission", (byte)4, "صدور مجوز", new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6346), null, true, false, new DateTime(2024, 4, 22, 22, 33, 35, 556, DateTimeKind.Local).AddTicks(6348) });
