    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { (byte)1, "Address", "Descriptions", "OrganicShop@gmail.com", null, "Tehran", null, null, "02134658899", null, null, "09121234455", null, null, "ShorDescriptions", new DateTime(2024, 6, 26, 5, 30, 59, 138, DateTimeKind.Local).AddTicks(508), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 138, DateTimeKind.Local).AddTicks(653) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { (byte)1, "Main Admin", null, "مدیر سایت", new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5519), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5564) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "mas1379as@gmail.com", "Mahdi Asadi", "123456", "09369753041", 2, new DateTime(2024, 6, 26, 5, 30, 59, 156, DateTimeKind.Local).AddTicks(3000), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 156, DateTimeKind.Local).AddTicks(3052) },
                    { 2L, "TestEmail@gmail.com", "AmirAli", "1234", "09331234566", 3, new DateTime(2024, 6, 26, 5, 30, 59, 156, DateTimeKind.Local).AddTicks(3241), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 156, DateTimeKind.Local).AddTicks(3248) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, (byte)1, 1L, new DateTime(2024, 6, 26, 5, 30, 59, 147, DateTimeKind.Local).AddTicks(907), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 147, DateTimeKind.Local).AddTicks(937) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { (byte)2, "Users Admin", (byte)1, "مدیریت کاربران", new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5568), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5577) },
                    { (byte)3, "Products Admin", (byte)1, "مدیریت محصولات", new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5584), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5586) },
                    { (byte)4, "Permissions Admin", (byte)1, "مدیریت مجوز ها", new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5589), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5591) },
                    { (byte)5, "Comments Admin", (byte)1, "مدیریت نظرات", new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5604), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5606) },
                    { (byte)6, "Discounts Admin", (byte)1, "مدیریت تخفیف ها", new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5622), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5625) },
                    { (byte)7, "Categories Admin", (byte)1, "مدیریت دسته ها", new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5628), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5644) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, null, null, true, "joker.png", null, null, 0.5f, 0, 1L, new DateTime(2024, 6, 26, 5, 30, 59, 148, DateTimeKind.Local).AddTicks(2012), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 148, DateTimeKind.Local).AddTicks(2038) });

            migrationBuilder.InsertData(
                table: "Permissions",
                columns: new[] { "Id", "EnTitle", "ParentId", "Title", "BaseEntity_CreateDate", "BaseEntity_DeleteDate", "BaseEntity_IsActive", "BaseEntity_IsDelete", "BaseEntity_LastModified" },
                values: new object[] { (byte)8, "Giving Permission", (byte)4, "صدور مجوز", new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5647), null, true, false, new DateTime(2024, 6, 26, 5, 30, 59, 146, DateTimeKind.Local).AddTicks(5649) });
